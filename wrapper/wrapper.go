...
#cgo linux,amd64 LDFLAGS: ${SRCDIR}/../third/lib/linux/amd64/libluban_static.a ${SRCDIR}/../third/lib/linux/amd64/libsample_luban_static.a ${SRCDIR}/../third/lib/linux/amd64/liblongmen_static.a /usr/local/lib/liblua.a -L/usr/local/lib -lstdc++ -ldl -lm -lc10 -ltorch_cpu -lpthread
#include <stdlib.h>
#include <string.h>
#include <stdio.h>
#include "longmen.h"
...
func (w *Wrapper) Rank(userFeatureRowsPtr unsafe.Pointer, itemIds []string) []float32 {
	...
	C.longmen_forward_rows(w.Ptr, userFeatureRowsPtr, (*C.char)(unsafe.Pointer(&items[0])), unsafe.Pointer(&lens[0]),
