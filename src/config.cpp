...
ModelConfigure::ModelConfigure(const std::shared_ptr<cpptoml::table> &table) :
        table_(table),
...
STFModelConfigure::STFModelConfigure(const std::shared_ptr<cpptoml::table> &table) :
        ModelConfigure(table),
