...
loader::Record::Record(std::shared_ptr<luban::ToolKit> &toolkit, const tensorflow::Features &features) : features_(features)
{
...
loader::Extractor::Extractor(std::shared_ptr<SlotsConfigure> &slot_conf, std::string data_file,
                             std::string luban_config_file) : slot_conf_(slot_conf),
